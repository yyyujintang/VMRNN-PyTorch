...
def get_args():
    ...
    parser.add_argument('--root_path', default='./data/processed_128/{}/')
    # parser.add_argument('--root_path', default='./data/kth_action/{}/')
    parser.add_argument('--checkpoint_path', default=None)


    # model parameters
    parser.add_argument('--model', default='VMRNN-D', type=str, choices=['VMRNN-B', 'VMRNN-D'],
                        help='Model type')
    ...
    parser.add_argument('--depths', default=[6], type=int, help='Depth of VSS Block for VMRNN-D')
    parser.add_argument('--depths_down', default=[2, 6], type=int, help='Downsample of VMRNN-D')
    parser.add_argument('--depths_up', default=[6, 2], type=int, help='Upsample of VMRNN-D')
    ...
    parser.add_argument('--log_train', default=2000, type=int)
    parser.add_argument('--log_valid', default=2000, type=int)
