...
if __name__ == '__main__':
    ...
    model = VMRNN(img_size=args.input_img_size, patch_size=args.patch_size,
                        in_chans=args.input_channels, embed_dim=args.embed_dim,
                        depths_downsample=args.depths_down, depths_upsample=args.depths_up).to(args.device)
    ...
    model.load_state_dict(torch.load('Pretrained/trained_model_state_dict_16.5_0.965'))
    # MSE: 16.46 SSIM: 0.9645
